...
public class DialogSheet {
    ...
    public DialogSheet setImageHolder(String imageUrl) {
        if(imageUrl != null){
            Glide.with(context).load(imageUrl).into(ImageHolder);
        }
        return this;
    }
    ...
    public DialogSheet setButtonsColorRes(@ColorRes int buttonsColorRes) {
        if(buttonsColorRes > 0)
            this.buttonColor = ContextCompat.getColor(context, buttonsColorRes);
        return this;
    }
    public DialogSheet setTitleColorRes(@ColorRes int titleColorRes) {
        if(titleColorRes > 0)
            this.titleColor = ContextCompat.getColor(context, titleColorRes);
        return this;
    }
    ...
    private void init(Context context) {
        ...
        ImageHolder = dialog.findViewById(R.id.dialogImage);
