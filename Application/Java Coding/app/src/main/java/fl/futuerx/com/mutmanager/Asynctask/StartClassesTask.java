...
public class StartClassesTask extends RetrofitCallTask<List<Attendance>> {

    private final int classId;
    private final String date;
    public StartClassesTask(Activity activity, int classId, String date, AsyncCallBack<List<Attendance>, String> callBack) {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        request.id   = classId;
        request.code = date;
        MakeCall( MUT_ATTENDANCE_API.getInstance().getApiInstance().startClass(request));
        return null;
    }
}
